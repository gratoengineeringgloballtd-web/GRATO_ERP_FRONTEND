...
// ── CEO Delegation ───────────────────────────────────────────────────────────
import { CEODelegationProvider, useCEODelegation } from './contexts/CEODelegationContext';
...
import EngineeringIncidentReportForm from './pages/employee/EngineeringIncidentReportForm';
import EngineeringIncidentDashboard from './pages/supervisor/EngineeringIncidentDashboard';
import PublicEngineeringIncidentViewer from './pages/public/PublicEngineeringIncidentViewer';
import EmployeeEngineeringIncidentDetail from './pages/employee/EmployeeEngineeringIncidentDetail';
...
import DocumentFieldPlacement from './pages/employee/DocumentFieldPlacement';
import DocumentSigningDashboard from './pages/employee/DocumentSigningDashboard';
import PublicSigningPage from './pages/public/PublicSigningPage';
import DocumentDetail from './pages/employee/DocumentDetail';


// ─────────────────────────────────────────────────────────────────────────────
// EnhancedProtectedRoute (v2 — CEO-delegation aware)
// Wraps ProtectedRoute with optional role-based access control.
// allowedRoles: if provided, user must be in the list OR be 'admin'/'ceo'
...
const EnhancedProtectedRoute = ({ children, allowedRoles, fallbackRole = null }) => {
  ...
  if (allowedRoles && allowedRoles.length > 0) {
    ...
    // Rule 2 — Global CEO delegate gets admin + finance access
    if (isGlobalDelegate && !isAdminRestricted) {
      return <ProtectedRoute>{children}</ProtectedRoute>;
    }

    // Rule 3 — Per-type delegation grants specific role access
    const hasDelegatedAccess =
      grantedRoles.length > 0 &&
      allowedRoles.some((requiredRole) => grantedRoles.includes(requiredRole));

    if (hasDelegatedAccess && !isAdminRestricted) {
      return <ProtectedRoute>{children}</ProtectedRoute>;
    }

    // Rule 4 — Normal direct role check
...
// ─────────────────────────────────────────────────────────────────────────────
// Shared sub-route arrays
// React Router v6 requires all children of <Routes>/<Route> to be literal
// <Route> elements. These helpers return plain arrays of <Route> elements
// which are spread directly into the parent <Route> via {inventoryRoutes()}.
// ─────────────────────────────────────────────────────────────────────────────

const inventoryRoutes = () => [
  <Route key="inv-1"  path="inventory"                     element={<InventoryDashboard />} />,
  <Route key="inv-2"  path="inventory/inbound"              element={<InboundTransaction />} />,
  <Route key="inv-3"  path="inventory/outbound"             element={<OutboundTransaction />} />,
...
const supplierMgmtRoutes = () => [
  <Route key="sm-1"  path="supplier-management"              element={<SupplyChainVendorManagement />} />,
  <Route key="sm-2"  path="suppliers"                         element={<SupplyChainVendorManagement />} />,
  <Route key="sm-3"  path="customer-vendor-management"        element={<SupplyChainCustomerVendorManagement />} />,
  <Route key="sm-4"  path="suppliers/:supplierId/profile"     element={<UnifiedSupplierProfile />} />,
  <Route key="sm-5"  path="supplier-onboarding"               element={<SupplyChainVendorOnboarding />} />,
  <Route key="sm-6"  path="supplier-approvals"                element={<SupplierApprovals />} />,
  <Route key="sm-7"  path="supplier-approvals/pending"        element={<SupplierApprovals />} />,
  <Route key="sm-8"  path="supplier-performance"              element={<SupplierPerformanceDashboard />} />,
  <Route key="sm-9"  path="supplier-performance/:supplierId"  element={<SupplierPerformanceDetail />} />,
];

const contractRoutes = () => [
  <Route key="cr-1"  path="contracts"                           element={<SupplyChainContracts />} />,
  <Route key="cr-2"  path="contracts/create"                    element={<ContractForm />} />,
  <Route key="cr-3"  path="contracts/:contractId"               element={<ContractDetails />} />,
  <Route key="cr-4"  path="contracts/:contractId/link-invoice"  element={<InvoiceContractLinking />} />,
];

const taskApprovalRoutes = () => [
  <Route key="ta-1"  path="action-items"                                        element={<SupervisorActionItemsDashboard />} />,
  <Route key="ta-2"  path="task-creation-approval/:taskId"                      element={<SupervisorTaskCreationApproval />} />,
  <Route key="ta-3"  path="task-completion-approval/:taskId/:assigneeId"        element={<SupervisorTaskCompletionApproval />} />,
  <Route key="ta-4"  path="action-items/:taskId/assignee/:assigneeId/review-l2" element={<SupervisorL2Review />} />,
  <Route key="ta-5"  path="action-items/:taskId/assignee/:assigneeId/review-l3" element={<SupervisorL3FinalApproval />} />,
];

const projectRoutes = () => [
  <Route key="pr-1"  path="project-management"        element={<SupplyChainProjectManagement />} />,
  <Route key="pr-2"  path="projects"                   element={<SupplyChainProjectManagement />} />,
  <Route key="pr-3"  path="projects/new"               element={<SupplyChainProjectManagement />} />,
  <Route key="pr-4"  path="projects/active"            element={<SupplyChainProjectManagement />} />,
  <Route key="pr-5"  path="projects/analytics"         element={<SupplyChainProjectManagement />} />,
  <Route key="pr-6"  path="projects/:projectId"        element={<RequestDetails />} />,
  <Route key="pr-7"  path="projects/:projectId/edit"   element={<SupplyChainProjectManagement />} />,
];

const communicationsRoutes = (prefix) => [
  <Route key="com-1" path="communications"           element={prefix === 'hr' ? <HRCommunicationsHub /> : <CommunicationsHub />} />,
  <Route key="com-2" path="communications/new"       element={<NewCommunication />} />,
  <Route key="com-3" path="communications/history"   element={<CommunicationsHistory />} />,
  <Route key="com-4" path="communications/scheduled" element={<CommunicationsHistory />} />,
  <Route key="com-5" path="communications/templates" element={<CommunicationTemplates />} />,
  ...(prefix === 'admin' ? [
    <Route key="com-6" path="communications/analytics" element={<CommunicationAnalytics />} />,
    <Route key="com-8" path="communications/:id/send"  element={<CommunicationDetail />} />,
  ] : []),
  <Route key="com-7" path="communications/:id"       element={<CommunicationDetail />} />,
  <Route key="com-9" path="communications/:id/edit"  element={<NewCommunication />} />,
];
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* ── PUBLIC ENGINEERING INCIDENT VIEWER (no auth required) ────── */}
        <Route path="/engineering-incidents/public/:token" element={<PublicEngineeringIncidentViewer />} />

        {/* External quote (no auth required) */}
        <Route path="/external-quote" element={
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                backgroundColor: '#f6ffed', borderRadius: '6px',
        ...
        <Route path="/sign/:documentId/:token" element={<PublicSigningPage />} />
        ...
        <Route path="/supplier" element={
          ...
          <Route path="dashboard"                 element={<SupplierInvoices />} />
        ...
        {/* ── EMPLOYEE ────────────────────────────────────────────────────── */}
        <Route path="/employee" element={<ProtectedRoute><PettyCashLayout /></ProtectedRoute>}>
          ...
          <Route path="purchase-requisitions/:requisitionId" element={<PurchaseRequisitionDetails />} />
          ...
          <Route path="site-incident"          element={<EngineeringIncidentReportForm />} />
          <Route path="site-incident-reports/:id"               element={<EmployeeEngineeringIncidentDetail />} />
          ...
          <Route path="documents/sign" element={<DocumentSigningDashboard />} />
          <Route path="documents/sign/new" element={<DocumentUpload />} />
          <Route path="documents/sign/:documentId" element={<DocumentDetail />} />
          {/* <Route path="documents/sign/:documentId" element={<DocumentSigningDashboard />} /> */}
          <Route path="documents/sign/:documentId/fields" element={<DocumentFieldPlacement />} />
        </Route>
        ...
        <Route path="/supervisor" element={
          ...
          <Route path="engineering-incident-reports"                      element={<EngineeringIncidentDashboard />} />
          {/* <Route path="engineering-incidents/public/:id"                      element={<PublicEngineeringIncidentViewer />} /> */}
        ...
        <Route path="/buyer" element={
          ...
          <Route path="requisitions/:requisitionId"              element={<PurchaseRequisitionDetails />} />
          ...
          <Route path="procurement/:taskId"                      element={<PurchaseRequisitionDetails />} />

          {/* Quotes */}
          <Route path="quotes"                                   element={<BuyerQuoteManagement />} />
          <Route path="quotes/:quoteId"                          element={<PurchaseRequisitionDetails />} />
          ...
          {/* Inventory (buyer access) */}
          {inventoryRoutes()}
        </Route>

        {/* ── SUPPLY CHAIN ────────────────────────────────────────────────── */}
        <Route path="/supply-chain" element={
          <EnhancedProtectedRoute allowedRoles={['supply_chain','project','buyer','admin','finance', 'ceo', 'it']}>
            <PettyCashLayout />
          </EnhancedProtectedRoute>
        }>
        ...
        <Route path="/finance" element={
          ...
          <Route path="budget-codes/:codeId/detail"              element={<BudgetCodeDetails />} />
          ...
          {/* Supplier management (finance view) */}
        ...
        <Route path="/legal" element={
          ...
          <Route index                       element={<LegalComplianceCenter />} />
          <Route path="dashboard"            element={<LegalComplianceCenter />} />
          <Route path="sdd"                  element={<LegalComplianceCenter />} />
          <Route path="sdd/:id"              element={<LegalComplianceCenter />} />
          <Route path="contracts"            element={<LegalComplianceCenter />} />
          <Route path="contracts/:id"        element={<LegalComplianceCenter />} />
          <Route path="regulatory"           element={<LegalComplianceCenter />} />
          <Route path="risks"                element={<LegalComplianceCenter />} />
          <Route path="analytics"            element={<LegalComplianceCenter />} />
        </Route>
        ...
        <Route path="/it" element={
          ...
          <Route path="approvals"                          element={<ITDashboard />} />
        ...
        <Route path="/admin" element={
          ...
          {/* Incidents */}
          <Route path="incident-reports"                   element={<EngineeringIncidentDashboard />} />
          <Route path="incident-reports/dashboard"         element={<EngineeringIncidentDashboard />} />
          <Route path="incident-reports/:reportId"         element={<RequestDetails />} />
          <Route path="incident-compliance"                element={<EngineeringIncidentDashboard />} />
          ...
          {/* Legal (admin passthrough) */}
          <Route path="legal/*"                            element={<LegalComplianceCenter />} />

          {/* Salary */}
          <Route path="salary-payments"                    element={<SalaryPaymentList />} />
          <Route path="salary-analytics"                   element={<AdminAnalyticsDashboard />} />
        </Route>
        ...
        {/* ── CEO DELEGATE MIRROR ROUTES ──────────────────────────────────
            Role-neutral routes for pages that are normally behind finance/admin
            guards but need to be reachable by a CEO delegate of any role.
            Access here only matters after the chain has been mutated to put
            the delegate's email in the CEO approval step — the page components
            filter by approver email, so a non-delegate who lands here sees
            nothing actionable.
        ─────────────────────────────────────────────────────────────────── */}
        <Route
          path="/ceo-delegate"
        ...
        >
          {/* Budget codes — mirrors /finance/budget-codes */}
          <Route
            path="budget-codes"
            element={<FinanceBudgetCodeApprovals />}
          />

          {/* Supplier approvals — mirrors /admin/supplier-approvals */}
          <Route
            path="supplier-approvals"
            element={<SupplierApprovals />}
          />

          {/* Salary payments — mirrors /finance/salary-payments */}
          <Route
            path="salary-payments"
            element={<SalaryPaymentList />}
          />

          {/* Invoice approvals — mirrors /finance/invoice-management */}
          <Route
            path="invoice-approvals"
            element={<FinanceInvoiceApproval />}
          />

          {/* Purchase requisition head approval */}
          <Route
            path="purchase-requisitions"
            element={<HeadApprovalPage />}
          />
        </Route>
        ...
        {/* ── SHAREPOINT ──────────────────────────────────────────────────── */}
        <Route path="/sharepoint" element={<ProtectedRoute><PettyCashLayout /></ProtectedRoute>}>
        ...
        {/* ── UNIVERSAL / MISC ────────────────────────────────────────────── */}
        <Route path="/account-settings" element={<ProtectedRoute><PettyCashLayout /></ProtectedRoute>}>
          <Route index element={<AccountSettings />} />
        </Route>

        <Route path="/analytics" element={
          <EnhancedProtectedRoute allowedRoles={[
            'supervisor','finance','hr','it','supply_chain','buyer','project','admin'
          ]}>
            <PettyCashLayout />
          </EnhancedProtectedRoute>
        }>
        ...
        <Route path="/employee-welfare" element={
        ...
        <Route path="/communications/:id/view" element={
          <ProtectedRoute><PettyCashLayout /></ProtectedRoute>
        }>
